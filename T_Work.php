    ...
    <!-- Content Header (Page header) -->
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="T_Work.php"><i class="fa fa-building"></i>Work Background</a></li>
        </ol>
      </section>
      <br>
      ...
      <section class="content">
        ...
        <form action="_T_Work.php" method="get">          

          <!--Work Background-->
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Add Work Background</h3>
              ...
              <table id="work" class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <form action="T_Work1.php?userid=<?php echo $_GET['userid'];?>&id=<?php echo $_GET['id'];?>" method="get">
                        ...
                        &nbsp;
                        <form action="T_Work2.php?userid=<?php echo $_GET['userid'];?>&id=<?php echo $_GET['id'];?>" method="get">
