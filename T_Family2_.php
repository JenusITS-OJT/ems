  ...
  <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <form action="_T_Family2_.php" method="get">
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <table id="family" class="table table-bordered table-striped">
                <?php $sql="SELECT
                    ...
                    WHERE f.`User_ID` = $userid and f.`id` = $id";
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $famoccupation ?></td>
                    <td><?php echo $famrelation ?></td>                 
                  </tr>                   
                </tfoot>
              </table>
            ...
            <div class="box-footer" align="right">
               ...
               <a href="T_Family_.php"><button type="button" class="btn btn-default">Cancel</button></a>
            </div>
          </div>
        </form>
