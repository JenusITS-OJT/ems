      ...
      <!-- SELECT2 EXAMPLE -->
          <div class="box box-warning">
            ...
            <div class="box-header">
              <h3 class="box-title">Add Educational Level</h3>
              ...
              <div class="box-body">                  
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="educationallevel" name="educationallevel" placeholder="Educational Level" required>
                  </div>
                </div>                    
                <div class="col-md-6">
                  <div class="form-group">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body" style="overflow-x:auto;">
              <table id="educational_level" class="table table-bordered table-striped">
                ...
                <?php $sql="SELECT `id`, `educational_level_name`, `status`
