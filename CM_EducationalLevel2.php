...
<div class="wrapper">
  <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
      ...
      <form action="_CM_EducationLevel2.php" method="get">
        <div class="box box-warning">
          ...
          <div class="box-header">
           ...
           <button type="submit" class="btn btn-warning">Delete Record</button>
                ...
                &nbsp;&nbsp;&nbsp;
                <a href="CM_EducationLevel.php"><button type="button" class="btn btn-default">Cancel</button></a>
              </div>
        </div>

          <div class="box box-warning">
          <div class="box-header">
            <h3 class="box-title">Educational Level</h3>
          </div>
          <!-- /.box-header -->
                  ...
                  <td>
                    <div class="btn-group">
                        <form action="CM_EducationLevel1.php?id=<?php echo $_GET['id'];?>" method="get">
                          ...
                          &nbsp;
                        <a href="CM_EducationalLevel2.php?id=<?php echo $_GET['id'];?>" method="get">
