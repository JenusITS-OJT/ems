  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <form action="_T_Education2_.php" method="get">
          <div class="box box-warning">
            ...
            <div class="box-footer" align="right">
              ...
              <a href="T_Education_.php"><button type="button" class="btn btn-default">Cancel</button></a>
            </div>
          </div>
        </form>
            ...
            <table id="education" class="table table-bordered table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <form action="T_Education1_.php?userid=<?php echo $_GET['userid'];?>&id=<?php echo $_GET['id'];?>" method="get">
                        ...
                        <input type="hidden" name="userid" value="<?php echo $userid; ?>"/>
            					...
            					&nbsp;
                      <form action="T_Education2_.php?userid=<?php echo $_GET['userid'];?>&id=<?php echo $_GET['id'];?>" method="get">
