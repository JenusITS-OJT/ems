    ...
    <!-- Content Header (Page header) -->
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="T_Contact_.php"><i class="fa fa-phone"></i>Contact</a></li>
        </ol>
      </section>
      <br>
      ...
      <section class="content">
        ...
        <form action="_T_Contact_.php" method="get">
            ...
            <div class="box-body">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="contactname" name="contactname" value="<?php echo $contactname; ?>" placeholder="Contact Person">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="contactno" name="contactno" value="<?php echo $contactno; ?>" placeholder="Contact Number">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="relation">Relation</label>
                    <select class="form-control" id="relation" name="relation" value="<?php echo $relation; ?>" placeholder="Relation" required>
              ...
              <table id="contactperson" class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <form action="T_Contact1_.php?userid=<?php echo $_GET['userid'];?>&id=<?php echo $_GET['id'];?>" method="get">
                        ...
                        &nbsp;
                        <form action="T_Contact2_.php?userid=<?php echo $_GET['userid'];?>&id=<?php echo $_GET['id'];?>" method="get">
