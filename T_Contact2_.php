  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
      ...
      <section class="content">
        ...
        <form action="_T_Contact2_.php" method="get">
          <div class="box box-warning">
            ...
            <div class="box-footer" align="right">
              ...
              <a href="T_Contact_.php"><button type="button" class="btn btn-default">Cancel</button></a>
            </div>
          </div>
        </form>
        ...
        <div class="box box-warning">
          <div class="box-header">
            <h3 class="box-title">Contact Person in case of Emergency</h3>
          </div>
          <!-- /.box-header -->
