  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
      ...
      <section class="content">
        ...
        <form action="_T_Education.php" method="get">

          <!--Educational Background-->
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Add Educational Background</h3>
            ...
            <div class="box-body">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <select class="form-control" id="educ" name="educ" placeholder="Educational Attainment" required>                      
                        <?php $sql="SELECT
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="school" name="school" placeholder="Name of School">
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="date" class="form-control pull-right" id="datepicker1" name="datepicker1" required></input>
                  </div>
                </div>
              </div>
              ...
              <table id="education" class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <form action="T_Education1.php?userid=<?php echo $_GET['userid'];?>id=<?php echo $GET_['id'];?>" method="get">
                        ...
                        &nbsp;
                        <form action="T_Education2.php?id=<?php echo $GET_['id'];?>&userid=<?php echo $GET_['userid'];?>" method="get">
